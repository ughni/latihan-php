...
//  ambil no dan username
    $reslut = mysqli_query( $conn, "SELECT username FROM user WHERE no = $no");
...
<body>
    ...
    <form action="" method="post">
        <ul>
            ...
            <li>
                <input type="checkbox" name="remember" id="remember" placholder="Remember me">
